...
async function generateResources() {
  ...
  document.getElementById('non_comp_notification' + result_rule.id).innerHTML = "Non-Compliant Resources:" + non_comp_counter;
  console.log(comp_counter);
  document.getElementById('comp_notification' + result_rule.id).innerHTML = "Compliant Resources:" + comp_counter;
